...
object AppMotion {
    ...
    const val PressSpringDampingRatio = 1f
    ...
    const val TodoCompletionCheckMillis = 180
    const val TodoCompletionCheckStartScale = 0.95f
    ...
    fun sectionItemFadeIn(): TweenSpec<Float> =
        tween(SectionItemFadeInMillis, easing = EmphasizedEasing)

    fun sectionItemFadeOut(): TweenSpec<Float> =
        tween(SectionItemFadeOutMillis, easing = StandardEasing)
